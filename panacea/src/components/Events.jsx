...
<div class="parent bg-black">
    ...
    <div class="max-w-lg bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <p class="mb-0 font-normal text-gray-700 dark:text-gray-400">Information About The Event</p>
        <p class="mb-0 font-normal text-gray-700 dark:text-gray-400">Date:</p>
