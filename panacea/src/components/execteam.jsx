...
import riya from '../images/RiyaSharma.png'
import tanuj from '../images/tanujKothari.jpg'
import saarang from '../images/SaarangKumar.png'
    ...
    <section class="text-gray-400 bg-black body-font">
      <div class="container px-5 py-24 mx-auto">
        ...
        <div class="flex flex-wrap -m-4">
            ...
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                ...
                <span class="inline-flex">
                  <a class="text-gray-700" href='https://www.instagram.com/_tanujkothari_'>
          ...
          <div class="p-4 lg:w-1/4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              <img alt="team" class="flex-shrink-0 rounded-lg w-full h-auto object-cover object-center mb-4" src={saarang}></img>
              <div class="w-full">
          ...
          <div class="p-4 lg:w-1/4 md:w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                ...
                <p class="mb-4">Dum Spiro Spero , a Latin quote which translates to While I breathe, I hope</p>
                <span class="inline-flex">
                  <a class="text-gray-700" href='https://instagram.com/_riya.28_?igshid=ZDdkNTZiNTM='>
                   <i class="fa fa-brands fa-instagram"></i>
                  </a>
                  <a class="ml-2 text-gray-700" href='http://www.linkedin.com/in/riya-sharma-11ba0022a'>
            ...
            <div class="h-full flex flex-col items-center text-center">
              ...
              <div class="w-full">
                ...
                <span class="inline-flex">
                  ...
                  <a class="ml-2 text-gray-700" href='https://instagram.com/samyak_1612?igshid=ZDdkNTZiNTM='>
                    <i class="fa fa-brands fa-instagram"></i>
                  </a>
                </span>
              </div>
