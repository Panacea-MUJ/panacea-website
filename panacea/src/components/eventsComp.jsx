...
import eventsTitle from '../components/eventsTitle.png';
...
const EventsComp = () =>{
    return(
        <>
        <section
      class="z-40 min-h-[100vh] relative text-neutral-50 pt-16 px-4 md:px-8 overflow-hidden 2xl:px-60 mx-auto grid grid-cols-1 gap-8 lg:grid-cols-12 relative bg-cover bg-[url('https://i.imgur.com/2lPUgWE.jpeg')]">
      <div
      ...
      >
        ...
        >
          Latest information on all our events.
        </p>
